...
using DesafioAlterdata.Application.Services;
...
namespace DesafioAlterdata
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                return s.GetRequiredService<IHttpClientFactory>().CreateClient("HGBrasil_API");
            });

            services.AddHttpClient<CotacaoService>();
            ...
            //    client.BaseAddress = new Uri(Configuration.GetSection("HG_Brasil_API:BaseURL").Value);
            //});
